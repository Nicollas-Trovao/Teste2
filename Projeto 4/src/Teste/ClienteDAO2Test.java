...
import main.DAO.ClienteDAO2;
import main.DAO.IClienteDAO;
import main.Domain.Cliente;

public class ClienteDAO2Test {
	...
	public ClienteDAO2Test() {
		this.clienteDao = new ClienteDAO1();
		this.clienteDao2 = new ClienteDAO2();
		rd = new Random();
	}
	...
	public void alterarCliente() {
		...
		clienteConsultado.setNome("Nicollas");
		clienteDao.alterar(clienteConsultado);
		
		Cliente clienteAlterado = clienteDao.consultar(clienteConsultado.getId());
		Assert.assertNotNull(clienteAlterado);
		Assert.assertEquals("Nicollas", clienteAlterado.getNome());
